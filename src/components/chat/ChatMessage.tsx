            ...
            <ReactMarkdown 
              ...
              components={{
                ...
                code: ({ node, className, children, ...props }) => {
                  ...
                  if (isInline) {
                    return <code className="px-1.5 py-0.5 mx-0.5 rounded-md bg-zinc-100 dark:bg-zinc-800 text-[13px] font-mono text-zinc-900 dark:text-zinc-200" {...props}>{children}</code>;
                  }
